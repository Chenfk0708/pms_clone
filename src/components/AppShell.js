...
export function AppShell({ path, pageTitle, children }) {
    ...
    return (_jsxs("div", { className: "app-shell", children: [_jsxs("header", { className: "topbar", children: [_jsxs("div", { className: "brand-block", children: [_jsx("div", { className: "brand-mark", children: "LOCALS" }), _jsxs("div", { className: "brand-store", children: [_jsx("strong", { children: "\u8DEF\u5BA2\u4E91 6TS5 \u7684\u5E97\u94FA" }), _jsx("span", { children: "\u7545\u4EAB\u7248" })] })] }), _jsx("nav", { className: "topnav", "aria-label": "\u9876\u90E8\u5BFC\u822A", children: topNav.map((item) => (_jsxs(NavLink, { to: item.path, "aria-label": item.label, className: ({ isActive }) => `topnav-link${isActive ||
