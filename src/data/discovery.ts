import type {
  ChannelCard,
  InformationFlowItem,
  InformationRadarMetric,
  InformationSummaryTag,
  SideNavGroup,
} from '../types'

export const socialConnectedCards: ChannelCard[] = [
  {
    name: '抖音来客',
    relation: '关联房型 0/0',
    support: '支持：日历房、预售券',
...
export const distributionSideNav: SideNavGroup[] = [
  {
    title: '聚合分销',
    items: [
...
export const globalRadarSideNav: SideNavGroup[] = [
  {
    title: '',
    items: [
...
export const informationSideNav: SideNavGroup[] = [
  {
    title: '信息维护',
    items: [
...
export const scrmSideNav: SideNavGroup[] = [
  {
    title: '',
