...
export const sideNavByPath: Record<string, SideNavGroup[]> = {
  '/workspace': [],
  '/houseManage/months': [
    {
      title: '房态管理',
...
const smartHotelNav: SideNavGroup[] = [
  {
    title: '智住管理',
    items: [
...
const informationNav: SideNavGroup[] = [
  {
    title: '璁剧疆',
...
const sideNavByPrefix: Array<{ prefix: string; groups: SideNavGroup[] }> = [
...
export function resolveSideNav(path: string): SideNavGroup[] {
...
export const houseDates: HouseDateColumn[] = [
...
export const houseRows: HouseRow[] = [
  {
...
export const orderRows: OrderRecord[] = [
  {
...
export const priceDates: PriceDateColumn[] = [
...
export const priceRows: PriceChannelRow[] = [
  {
    channel: '途家',
    coefficient: '-',
    basePrice: '730',
...
export const otaConnectedCards: OtaConnectedCard[] = [
...
export const otaPendingCards: OtaPendingCard[] = [
  { name: '携程玩乐' },
  { name: 'Booking' },
  { name: '携程国际' },
  { name: '爱彼迎' },
...
export const reportBusinessCards: ReportSummaryCard[] = [
...
export const reportOperationCards: ReportSummaryCard[] = [
