...
function CalendarRoomDialog({ dialog, onClose, onConfirm, }) {
    ...
    return (_jsx("div", { className: "calendar-room-dialog-mask", role: "presentation", onMouseDown: onClose, children: _jsxs("section", { className: "calendar-room-dialog calendar-room-dialog--status", role: "dialog", "aria-modal": "true", "aria-label": "\u552E\u5356\u72B6\u6001\u786E\u8BA4", onMouseDown: (event) => event.stopPropagation(), children: [_jsxs("header", { children: [_jsx("span", { className: "calendar-room-dialog__warning", "aria-hidden": "true", children: "!" }), _jsxs("div", { className: "calendar-room-dialog__status-copy", children: [_jsx("strong", { children: title }), description ? _jsx("p", { children: description }) : null] })] }), _jsxs("footer", { children: [_jsx("button", { type: "button", onClick: onClose, children: "\u53D6\u6D88" }), _jsx("button", { type: "button", className: "is-primary", onClick: () => onConfirm('售卖状态已更新'), children: "\u786E\u5B9A" })] })] }) }));
}
