...
export function CleanLogPage() {
    ...
    return (_jsxs("div", { className: "clean-log-page", children: [_jsxs("section", { className: "clean-log-panel", children: [_jsxs("div", { className: "clean-log-query", "aria-label": "\u4FDD\u6D01\u65E5\u5FD7\u7B5B\u9009", children: [_jsx("button", { type: "button", "aria-pressed": "true", children: "\u5168\u90E8\u95E8\u5E97" }), _jsx("button", { type: "button", children: options.stores[1]?.label ?? '当前门店' }), _jsx("button", { type: "button", onClick: () => setRoomDialogOpen(true), children: selectedRoom ? selectedRoom.label : '请选择房间' }), _jsxs("label", { children: [_jsx("span", { children: "\u64CD\u4F5C\u65E5\u671F" }), _jsx("input", { "aria-label": "\u64CD\u4F5C\u65E5\u671F\u5F00\u59CB", placeholder: "\u5F00\u59CB\u65E5\u671F", value: startDate, onChange: (event) => setStartDate(event.target.value) }), _jsx("input", { "aria-label": "\u64CD\u4F5C\u65E5\u671F\u7ED3\u675F", placeholder: "\u7ED3\u675F\u65E5\u671F", value: endDate, onChange: (event) => setEndDate(event.target.value) })] }), _jsx("button", { type: "button", onClick: () => setOperatorOpen((open) => !open), children: selectedOperator?.label ?? '请选择操作人' }), _jsx("button", { type: "button", onClick: () => refresh('查询完成'), children: "\u67E5\u8BE2" }), _jsx("button", { type: "button", onClick: reset, children: "\u91CD\u7F6E" }), _jsx("button", { type: "button", onClick: () => refresh(), children: "\u5237\u65B0" }), _jsx("button", { type: "button", onClick: exportLogs, disabled: rows.length === 0, children: "\u5BFC\u51FA" })] }), operatorOpen ? (_jsx("div", { className: "clean-log-popover", role: "listbox", "aria-label": "\u64CD\u4F5C\u4EBA\u7B5B\u9009", children: options.operators.map((operator) => (_jsx("button", { type: "button", role: "option", "aria-selected": selectedOperatorId === operator.value, onClick: () => {
