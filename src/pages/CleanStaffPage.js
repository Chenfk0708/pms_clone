...
export function CleanStaffPage() {
    ...
    const loadDashboard = useCallback(async (signal) => {
        ...
        try {
            ...
            setFeedback((current) => current.startsWith('已刷新') ? current : `已同步 ${nextDashboard.pagination.total} 名保洁人员`);
        }
        catch (loadError) {
...
function AddDialog({ isSaving, onCancel, onSave, }) {
    return (_jsx("div", { className: "clean-staff-dialog-backdrop", children: _jsxs("section", { className: "clean-staff-dialog clean-staff-dialog--form", role: "dialog", "aria-modal": "true", "aria-label": "\u65B0\u589E\u4FDD\u6D01\u5458", children: [_jsxs("header", { children: [_jsxs("div", { children: [_jsx("h2", { children: "\u65B0\u589E\u4FDD\u6D01\u5458" }), _jsx("span", { children: "\u4FDD\u5B58\u540E\u540C\u6B65\u5230\u5F53\u524D\u4FDD\u6D01\u4EBA\u5458\u5217\u8868\u3002" })] }), _jsx("button", { type: "button", onClick: onCancel, children: "\u53D6\u6D88" })] }), _jsxs("label", { children: [_jsx("span", { children: "\u59D3\u540D" }), _jsx("input", { defaultValue: "\u5468\u654F" })] }), _jsxs("label", { children: [_jsx("span", { children: "\u624B\u673A\u53F7" }), _jsx("input", { defaultValue: "18612345678" })] }), _jsxs("label", { children: [_jsx("span", { children: "\u8D1F\u8D23\u623F\u6E90" }), _jsx("input", { defaultValue: "\u89C2\u5F71\u5927\u5E8A\u623F\u3001\u603B\u88C1\u5957\u95F4" })] }), _jsxs("footer", { children: [_jsx("button", { type: "button", onClick: onCancel, disabled: isSaving, children: "\u53D6\u6D88" }), _jsx("button", { type: "button", className: "is-primary", onClick: onSave, disabled: isSaving, children: "\u4FDD\u5B58\u6210\u5458" })] })] }) }));
}
