...
export function HouseDaysPage() {
    ...
    const storeOptions = useMemo(() => backendStoreOptions.map((store) => ({ id: store.id, name: store.label })), [backendStoreOptions]);
