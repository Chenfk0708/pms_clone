...
function DatePanel({ month, startDate, endDate, pickTarget, position, onClose, onPrevious, onNext, onPick, onConfirm, }) {
    const months = [month, shiftMonth(month, 1)];
    return (_jsx("div", { className: "order-ledger-date-panel-wrap", role: "presentation", onMouseDown: onClose, children: _jsxs("section", { className: "order-ledger-date-panel", role: "dialog", "aria-label": "\u65E5\u671F\u9009\u62E9", style: { top: `${position.top}px`, left: `${position.left}px` }, onMouseDown: (event) => event.stopPropagation(), children: [_jsxs("div", { className: "order-ledger-date-panel__header", children: [_jsx("strong", { children: pickTarget === 'start' ? '请选择开始日期' : '请选择结束日期' }), _jsx("button", { type: "button", "aria-label": "\u5173\u95ED\u8BB0\u4E00\u7B14\u660E\u7EC6\u65E5\u671F\u9762\u677F", onClick: onClose, children: "\u00D7" })] }), _jsxs("div", { className: "order-ledger-date-panel__range", children: [_jsx("span", { children: startDate }), _jsx("em", { children: "\u81F3" }), _jsx("span", { children: endDate })] }), _jsx("div", { className: "order-ledger-date-panel__months", children: months.map((item, index) => (_jsx(CalendarMonth, { month: item, startDate: startDate, endDate: endDate, onPrevious: index === 0 ? onPrevious : undefined, onNext: index === months.length - 1 ? onNext : undefined, onPick: onPick }, item))) }), _jsx("footer", { className: "order-ledger-date-panel__footer", children: _jsx("button", { type: "button", onClick: onConfirm, children: "\u786E\u5B9A" }) })] }) }));
}
function CalendarMonth({ month, startDate, endDate, onPrevious, onNext, onPick, }) {
    ...
    return (_jsxs("section", { className: "order-ledger-calendar-month", "aria-label": formatMonthLabel(month), children: [_jsxs("header", { children: [_jsx("button", { type: "button", "aria-label": "\u4E0A\u4E2A\u6708", onClick: onPrevious, disabled: !onPrevious, children: "\u2039" }), _jsx("strong", { children: formatMonthLabel(month) }), _jsx("button", { type: "button", "aria-label": "\u4E0B\u4E2A\u6708", onClick: onNext, disabled: !onNext, children: "\u203A" })] }), _jsx("div", { className: "order-ledger-calendar-month__weekdays", children: ['一', '二', '三', '四', '五', '六', '日'].map((day) => (_jsx("span", { children: day }, day))) }), _jsx("div", { className: "order-ledger-calendar-month__days", children: days.map((day) => {
                    ...
                    return (_jsx("button", { type: "button", "aria-label": `选择 ${day.date}`, className: `${day.isMuted ? 'is-muted' : ''}${inRange ? ' is-in-range' : ''}${isSelected ? ' is-selected' : ''}`, onClick: () => onPick(day.date), children: day.label }, day.date));
                }) })] }));
}
function RowDialog({ row, onClose }) {
    return (_jsx("div", { className: "ledger-entry-dialog-layer", children: _jsxs("section", { className: "ledger-entry-dialog", role: "dialog", "aria-modal": "true", "aria-label": "\u8D26\u672C\u660E\u7EC6\u8BE6\u60C5", children: [_jsxs("header", { children: [_jsx("strong", { children: "\u8D26\u672C\u660E\u7EC6\u8BE6\u60C5" }), _jsx("button", { type: "button", "aria-label": "\u5173\u95ED\u660E\u7EC6\u8BE6\u60C5", onClick: onClose, children: "\u00D7" })] }), _jsxs("dl", { children: [_jsxs("div", { children: [_jsx("dt", { children: "\u9879\u76EE" }), _jsx("dd", { children: row.project })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u6E20\u9053" }), _jsx("dd", { children: row.channelName })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u623F\u578B / \u623F\u95F4" }), _jsxs("dd", { children: [row.roomCategoryName, " / ", row.roomName] })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u652F\u4ED8\u65B9\u5F0F" }), _jsx("dd", { children: row.paymentWay })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u5907\u6CE8" }), _jsx("dd", { children: row.remark })] }), _jsxs("div", { children: [_jsx("dt", { children: "\u64CD\u4F5C\u4EBA" }), _jsx("dd", { children: row.operatorName })] })] }), _jsx("footer", { children: _jsx(Link, { to: "/statistics/orderLedger", children: "\u67E5\u770B\u6536\u652F\u660E\u7EC6" }) })] }) }));
}
function SummaryDialog({ dashboard, summaryKey, onClose, }) {
    const card = dashboard?.summaryCards.find((item) => item.key === summaryKey);
    const title = card?.title ?? (summaryKey === 'income' ? '收入(元)' : '支出 (元)');
    return (_jsx("div", { className: "ledger-entry-dialog-layer", children: _jsxs("section", { className: "ledger-entry-dialog", role: "dialog", "aria-modal": "true", "aria-label": `${title}详情`, children: [_jsxs("header", { children: [_jsxs("strong", { children: [title, "\u8BE6\u60C5"] }), _jsx("button", { type: "button", "aria-label": "\u5173\u95ED\u8BE6\u60C5", onClick: onClose, children: "\u00D7" })] }), _jsx("p", { children: card?.detail ?? '账本分页接口返回当前筛选范围内的流水明细。' }), _jsx("p", { children: "\u8D26\u672C\u5206\u9875\u63A5\u53E3\uFF1A/orderLedger/dashboard/get" }), _jsx("footer", { children: _jsx(Link, { to: "/statistics/orderLedger", children: "\u67E5\u770B\u6536\u652F\u660E\u7EC6" }) })] }) }));
}
function StoreDialog({ onClose }) {
    return (_jsx("div", { className: "ledger-entry-dialog-layer", children: _jsxs("section", { className: "ledger-entry-dialog", role: "dialog", "aria-modal": "true", "aria-label": "\u95E8\u5E97\u8BBE\u7F6E", children: [_jsxs("header", { children: [_jsx("strong", { children: "\u95E8\u5E97\u8BBE\u7F6E" }), _jsx("button", { type: "button", "aria-label": "\u5173\u95ED\u95E8\u5E97\u8BBE\u7F6E", onClick: onClose, children: "\u00D7" })] }), _jsx("p", { children: "\u5F53\u524D\u9875\u9762\u6309\u95E8\u5E97\u7EF4\u5EA6\u67E5\u8BE2\u8D26\u672C\u6D41\u6C34\uFF0C\u53EF\u8DF3\u8F6C\u5230\u5173\u8054\u62A5\u8868\u7EE7\u7EED\u6838\u5BF9\u3002" }), _jsxs("footer", { children: [_jsx(Link, { to: "/statistics/orderLedger", children: "\u524D\u5F80\u6536\u652F\u660E\u7EC6" }), _jsx(Link, { to: "/statistics/totalLedger", children: "\u524D\u5F80\u6536\u652F\u6C47\u603B" })] })] }) }));
}
