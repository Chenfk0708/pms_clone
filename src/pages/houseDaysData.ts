...
export const houseDaysDataSource = {
  ...
  blocker:
    '本地 SPA 目前没有可复用的已认证 PMS API 代理或统一请求层，实时接口无法安全接入；当前数据为固定 Chrome 目标站取证快照，未静默伪装为实时成功。',
}

export const statusGroups: Array<{ title: string; items: StatusFilterItem[] }> = [
  {
    title: '入离',
    items: [
...
export const roomCards: DayRoomCard[] = [
  {
