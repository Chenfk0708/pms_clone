...
export function createDefaultCleanSettingFilters(searchParams = new URLSearchParams()) {
    return {
...
function adaptCleanSettingEnvelope(envelope, filters, provider) {
    if (envelope.code !== 0) {
...
function createSuccessPayload(filters) {
