...
export function getDefaultCleanStatisticsFilters() {
...
export function createCleanStatisticsRequestBody(filters) {
    return {
...
export async function fetchCleanStatisticsDashboard(filters, signal) {
...
function makeEnvelope(code, message, data, suffix, requestBody) {
    return {
        code,
        message,
        data,
...
function adaptDashboard(envelope, requestBody) {
    if (envelope.code !== 0) {
...
function adaptRoomCategories(data) {
...
function endOfShanghaiDay(date) {
...
function filterOptions(options, selectedIds) {
