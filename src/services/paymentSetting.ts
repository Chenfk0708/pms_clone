...
const initialPaymentMethods: PaymentMethodRecord[] = [
  ...
  {
    id: 'payment-enterprise-monthly',
    code: 'enterprise_monthly',
    name: '企业月结',
    status: 'disabled',
    isSystemDefault: false,
    isPreferred: false,
    description: '用于企业协议客户的月度统一结算。',
    availableScopes: ['企业结算'],
    settlementAccount: '企业月结台账',
    lastUsedAt: '2026-05-11 09:20',
    updatedAt: '2026-05-11 09:20',
    remark: '自定义支付方式，可启停、可设为默认。',
  },
  {
    id: 'payment-deposit-balance',
    code: 'deposit_balance',
    name: '押金抵扣',
    status: 'disabled',
    isSystemDefault: false,
    isPreferred: false,
    description: '用于押金抵扣房费或赔付场景。',
    availableScopes: ['押金抵扣'],
    settlementAccount: '押金抵扣台账',
    lastUsedAt: '2026-05-08 13:42',
    updatedAt: '2026-05-08 13:42',
    remark: '自定义支付方式，可启停、可设为默认。',
  },
  {
    id: 'payment-group-booking',
    code: 'group_booking',
    name: '团建挂账',
    status: 'disabled',
    isSystemDefault: false,
    isPreferred: false,
    description: '用于团建、长包等特殊挂账场景。',
    availableScopes: ['团建结算', '长包挂账'],
    settlementAccount: '团建挂账台账',
    lastUsedAt: '2026-05-06 18:05',
    updatedAt: '2026-05-06 18:05',
    remark: '自定义支付方式，可启停、可设为默认。',
  },
]
